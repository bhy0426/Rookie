// FILE: data/GrammarData.ts
// PURPOSE: GRAMMAR DATA. 문법 브라우저와 상세 페이지가 공유하는 타입과 문법 데이터를 보관합니다.
// FLOW 01: 문법 데이터에 필요한 TypeScript 타입을 먼저 정의합니다.
// FLOW 02: makeContent helper로 EditorBlock에 들어갈 public/protected/private 데이터를 만듭니다.
// FLOW 03: grammarItems 원본 배열을 만들고, export된 grammarData가 목록/상세 페이지에서 공유됩니다.
