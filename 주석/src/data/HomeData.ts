// FILE: data/HomeData.ts
// PURPOSE: HOME DATA. Home 페이지의 섹션 텍스트, 링크, 카드 데이터를 보관합니다.
// FLOW 01: Home 페이지가 map으로 렌더링할 섹션 데이터를 배열로 정의합니다.
// FLOW 02: section.variant 값에 따라 Home.tsx에서 다른 visual UI가 선택됩니다.
